...
let create = function (obj_str, pos, scale, y_up, col)
{
    //let eol = /\r\n|\n\r|\r/g;
    ...
    for (let i in lines)
    {
        ...
        if (tokens[0] === 'v' || tokens[0] === 'V')
        {
            if (!y_up)
            {
                v.push([parseFloat(tokens[1]) * scale + pos[0],
                        parseFloat(tokens[2]) * scale + pos[1],
                        parseFloat(tokens[3]) * scale + pos[2]]);
            }
            else
            {
                v.push([parseFloat(tokens[1]) * scale + pos[0],
                        parseFloat(tokens[3]) * scale + pos[1],
                        parseFloat(tokens[2]) * scale + pos[2]]);
            }
        }
...
v = { x:1, y:-1, z:-1}; n = { x:0, y:0, z:1}; v2 = vec3.mmul4(m, v); n2 = vec3.normalize(vec3.mmul(mat4.mat3(m), n));
f.push(v2.x, v2.y, v2.z, col[0], col[1], col[2], n2.x, n2.y, n2.z);
v = { x:1, y:-1, z:1}; n = { x:0, y:0, z:1}; v2 = vec3.mmul4(m, v); n2 = vec3.normalize(vec3.mmul(mat4.mat3(m), n));
f.push(v2.x, v2.y, v2.z, col[0], col[1], col[2], n2.x, n2.y, n2.z);
v = { x:-1, y:-1, z:1}; n = { x:0, y:0, z:1}; v2 = vec3.mmul4(m, v); n2 = vec3.normalize(vec3.mmul(mat4.mat3(m), n));
f.push(v2.x, v2.y, v2.z, col[0], col[1], col[2], n2.x, n2.y, n2.z);
...
v = { x:-1, y:-1, z:-1}; n = { x:0, y:0, z:1}; v2 = vec3.mmul4(m, v); n2 = vec3.normalize(vec3.mmul(mat4.mat3(m), n));
f.push(v2.x, v2.y, v2.z, col[0], col[1], col[2], n2.x, n2.y, n2.z);
v = { x:1, y:-1, z:1}; n = { x:-1, y:0, z:0}; v2 = vec3.mmul4(m, v); n2 = vec3.normalize(vec3.mmul(mat4.mat3(m), n));
f.push(v2.x, v2.y, v2.z, col[0], col[1], col[2], n2.x, n2.y, n2.z);
v = { x:1, y:-1, z:-1}; n = { x:-1, y:0, z:0}; v2 = vec3.mmul4(m, v); n2 = vec3.normalize(vec3.mmul(mat4.mat3(m), n));
f.push(v2.x, v2.y, v2.z, col[0], col[1], col[2], n2.x, n2.y, n2.z);
v = { x:1, y:1, z:-1}; n = { x:-1, y:0, z:0}; v2 = vec3.mmul4(m, v); n2 = vec3.normalize(vec3.mmul(mat4.mat3(m), n));
...
v = { x:-1, y:-1, z:-1}; n = { x:1, y:0, z:0}; v2 = vec3.mmul4(m, v); n2 = vec3.normalize(vec3.mmul(mat4.mat3(m), n));
f.push(v2.x, v2.y, v2.z, col[0], col[1], col[2], n2.x, n2.y, n2.z);
v = { x:-1, y:-1, z:1}; n = { x:0, y:-1, z:0}; v2 = vec3.mmul4(m, v); n2 = vec3.normalize(vec3.mmul(mat4.mat3(m), n));
f.push(v2.x, v2.y, v2.z, col[0], col[1], col[2], n2.x, n2.y, n2.z);
v = { x:1, y:-1, z:1}; n = { x:0, y:-1, z:0}; v2 = vec3.mmul4(m, v); n2 = vec3.normalize(vec3.mmul(mat4.mat3(m), n));
f.push(v2.x, v2.y, v2.z, col[0], col[1], col[2], n2.x, n2.y, n2.z);
v = { x:1, y:1, z:1}; n = { x:0, y:-1, z:0}; v2 = vec3.mmul4(m, v); n2 = vec3.normalize(vec3.mmul(mat4.mat3(m), n));
...
f.push(v2.x, v2.y, v2.z, col[0], col[1], col[2], n2.x, n2.y, n2.z);
 ...
 v = { x:1, y:-1, z:-1}; n = { x:0, y:0, z:0}; v2 = vec3.mmul4(m, v); n2 = vec3.normalize(vec3.mmul(mat4.mat3(m), n));
l.push(v2.x, v2.y, v2.z, col[0], col[1], col[2], n2.x, n2.y, n2.z);
v = { x:1, y:-1, z:1}; n = { x:0, y:0, z:0}; v2 = vec3.mmul4(m, v); n2 = vec3.normalize(vec3.mmul(mat4.mat3(m), n));
l.push(v2.x, v2.y, v2.z, col[0], col[1], col[2], n2.x, n2.y, n2.z);
v = { x:1, y:-1, z:1}; n = { x:0, y:0, z:0}; v2 = vec3.mmul4(m, v); n2 = vec3.normalize(vec3.mmul(mat4.mat3(m), n));
l.push(v2.x, v2.y, v2.z, col[0], col[1], col[2], n2.x, n2.y, n2.z);
